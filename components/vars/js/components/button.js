...
exports["icon-color"] = darkest["red-600"];
exports["background-color"] = darkest["background-color-transparent"];
exports["border-color"] = darkest["red-600"];
exports["text-color"] = darkest["red-600"];
exports["icon-color-hover"] = darkest["gray-50"];
exports["background-color-hover"] = darkest["red-600"];
exports["border-color-hover"] = darkest["red-600"];

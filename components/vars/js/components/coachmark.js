...
exports["indicator-ring-default-color"] = lightest["focus-color"];
...
exports["title-text-color"] = lightest["title-text-color"];
exports["content-text-color"] = lightest["text-color"];
exports["step-text-color"] = lightest["label-text-color"];
...
exports["entry-animation-distance"] = medium["size-75"];
...
exports["exit-animation-distance"] = medium["size-75"];

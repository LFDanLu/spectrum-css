...
exports["background-color-selected"] = lightest["gray-300"];
exports["border-color-selected"] = lightest["gray-300"];
exports["text-color-selected"] = lightest["text-color"];
exports["hold-icon-color-selected"] = lightest["icon-color-selected"];
exports["icon-color-selected"] = lightest["icon-color"];
exports["border-size-selected-hover"] = staticAliases["border-size-thin"];
exports["background-color-selected-hover"] = lightest["gray-300"];
exports["border-color-selected-hover"] = lightest["gray-300"];
exports["text-color-selected-hover"] = lightest["text-color-hover"];
exports["hold-icon-color-selected-hover"] = lightest["icon-color-selected-hover"];
exports["icon-color-selected-hover"] = lightest["icon-color-hover"];
exports["border-size-selected-down"] = staticAliases["border-size-thin"];
exports["background-color-selected-down"] = lightest["gray-300"];
exports["border-color-selected-down"] = lightest["gray-300"];
exports["text-color-selected-down"] = lightest["text-color-down"];
exports["hold-icon-color-selected-down"] = lightest["icon-color-selected-down"];
exports["icon-color-selected-down"] = lightest["icon-color-down"];
exports["background-color-selected-key-focus"] = lightest["gray-300"];
...
exports["text-color-selected-key-focus"] = lightest["text-color-hover"];
exports["hold-icon-color-selected-key-focus"] = lightest["icon-color-selected-focus"];
exports["icon-color-selected-key-focus"] = lightest["icon-color-hover"];

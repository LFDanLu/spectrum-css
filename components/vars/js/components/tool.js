...
exports["icon-color-selected"] = lightest["icon-color-over-background"];
exports["hold-icon-color-selected"] = lightest["icon-color-over-background"];
exports["background-color-selected"] = colorGlobals["static-blue-600"];
exports["border-color-selected"] = colorGlobals["static-blue-600"];
exports["icon-color-selected-hover"] = lightest["icon-color-over-background"];
exports["hold-icon-color-selected-hover"] = lightest["icon-color-over-background"];
exports["background-color-selected-hover"] = colorGlobals["static-blue-700"];
exports["border-color-selected-hover"] = colorGlobals["static-blue-700"];
exports["icon-color-selected-down"] = lightest["icon-color-over-background"];
exports["hold-icon-color-selected-down"] = lightest["icon-color-over-background"];
exports["background-color-selected-down"] = colorGlobals["static-blue-700"];
exports["border-color-selected-down"] = colorGlobals["static-blue-700"];
exports["icon-color-selected-key-focus"] = lightest["icon-color-over-background"];
exports["hold-icon-color-selected-key-focus"] = lightest["icon-color-over-background"];
exports["background-color-selected-key-focus"] = colorGlobals["static-blue-700"];
...
exports["background-color-selected-disabled"] = lightest["background-color-transparent"];
exports["border-color-selected-disabled"] = lightest["border-color-transparent"];
...
exports["border-offset-selected-key-focus"] = staticAliases["border-size-thick"];
